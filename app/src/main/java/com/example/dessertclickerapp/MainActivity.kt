...
private fun shareSoldDessertsInformation(intentContext: Context, dessertsSold: Int, revenue: Int){
    ...
    try{
        ...
        (e: ActivityNotFoundException){
            Toast.makeText(
                intentContext,intentContext.getString(R.string.sharing_not_available),Toast.LENGTH_LONG).show()
        }
}
...
@Composable
fun DessertClickerAppBar(onSharedButtonClicked: () -> Unit, modifier: Modifier) {
    Row(
        modifier = modifier,
...
@Composable
private fun DessertSoldInfo(dessertsSold: Int, modifier: Modifier) {
...
fun MyDessertClickerAppPreview(){
   DessertClickerAppTheme {
       DessertClickerApp(listOf(Dessert(
           R.drawable.lollipop,23,1
       )))
   }
}
